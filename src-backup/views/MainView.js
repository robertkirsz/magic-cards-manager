...
import databaseMaker from 'database/databaseMaker'
...
class MainView extends React.Component {
  ...
  async getCardsFromTheServer () {
    console.log('⬇️ Downloading started')
    const magicDatabase = await databaseMaker()
    if (magicDatabase) {
      console.log('👍 Downloading completed!')
      this.setState({...magicDatabase}) // 'magicCards', 'latestSet', 'setsNumber', 'uniqueCardsNumber'
  ...
  render () {
    const {
      ...
      showSearchDatabasePanel, showSearchCollectionPanel, magicCards
    } = this.state
    ...
    const searchDatabasePanel = (
      <Search
        ...
        collectionToSearchIn={magicCards}
